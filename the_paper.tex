...
%
\footnote{\citeA{eder_does_2015} suggests a 5000 word minimum for authorship studies on prose. Later \citeyear[4]{eder_short_2017} he revises this to ``as little as 2000 words in many cases'', which is still a great deal too many to be viable for many questions concerning poetry.}
%
...
I have accepted the views of \citeA[88-9]{allen_vox_1965} (which apparently accord closely with Knight's), but this would be a poor venue in which to set out the entire debate. In any event, it can be hoped that as long as the analysis is being applied consistently to all texts that the statistical effect of any systemic errors will be negligible.
...
\footnote{For an excellent summary of background to this issue I refer the reader to \citeA{lee_silius_2017}, which includes a valiant attempt at univariate metrical analysis (20-9), as well as a survey of the existing opinions in secondary literature (Appendix 1, p. 144).}
At just over 500 words, the disputed text is too short to be a useful candidate for BOW or function-word approaches%
\footnote{As mentioned, this question of ``how much text is enough?'' has been explored effectively by Eder (\citeyearNP{eder_does_2015} and \citeyearNP{eder_short_2017}).}
